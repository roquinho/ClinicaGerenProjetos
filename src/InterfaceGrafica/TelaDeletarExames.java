...
import brr.upe.poo.clinica.regraNegocio.ExceptionRegraNegocioDeletarExames;
 ...
 * @author manoel
 */
public class TelaDeletarExames extends javax.swing.JFrame {

    /**
     * Creates new form TelaDeletarExames
     */
    public TelaDeletarExames() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deletar exames");
        ...
        getContentPane().add(cpfText, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, 140, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 70, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TelaDeletarExames.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            fachada.deletarExame(exame);
